  ...
  static generateSampleCSV(): string {
    ...
    const sampleData = [
      [
        ...
        'يصرف بدل', '2024-01-15', '0509876543', 'SA1234567890123456789012', 'حارس ممتاز'
      ],
      [
        'مكة', 'جدة', 'جدة', 'مدرسة النور المتوسطة', 'فاطمة أحمد',
        '0507654321', 'سالم محمد', '0987654321', 'ذكر', '1980-12-20',
        'لا يصرف', '2024-02-01', '0501122334', 'SA9876543210987654321098', ''
      ],
      [
        'الشرقية', 'الدمام', 'الخبر', 'مدرسة الفجر الثانوية', 'عبدالله سالم',
        '0503456789', 'أحمد سالم', '1122334455', 'ذكر', '1990-03-10',
        'يصرف بدل', '2024-01-20', '0505566778', 'SA5544332211009988776655', 'في إجازة مرضية'
      ]
    ];
